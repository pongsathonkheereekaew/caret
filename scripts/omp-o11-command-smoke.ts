/** Real standalone OMP + Caret host: every pinned RPC name except turn/OAuth. No paid model calls. */
...
const executable = resolve(process.env.CARET_OMP_BINARY ?? join(root, "dist/omp-standalone/omp"));
...
const fixture = mkdtempSync(join(tmpdir(), "caret-o11-"));
const checks: string[] = [];
