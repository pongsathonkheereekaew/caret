...
the Apache License, Version 2.0. The Caret request/response protocol and host
and client orchestration in the remaining files are Caret code.
...
does not grant a right to use the Paseo or Caret names as trademarks.
