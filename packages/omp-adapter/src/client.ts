...
import {
	...
	RPC_COMMAND_TYPES,
	CARET_UI_COMMAND_TYPES,
	type CaretUiCommandType,
	type OmpFrame,
...
export class OmpRpcClient {
	 ...
	 * approvals and host capabilities under the Caret host's control.
	 */
	...
	#newRequestId(): string {
		...
		this.#requestCounter++;
		return `caret_${process.pid}_${Date.now().toString(36)}_${globalSequence.toString(36)}_${this.#requestCounter.toString(36)}`;
	}
