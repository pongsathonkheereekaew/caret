...
| Codex visual reference | product/design owner | sanitized capture | Cursor screenshot or inferred parity |
...
- ไม่ประกาศ Cursor/Codex parity; Codex current runtime capture ยัง blocked ตาม interaction spec.
