# Archived control-repo handoff — 2026-09-10

Living status: [CARET-HANDOFF-2026-09-13](../2026-09-14-pre-ssot/CARET-HANDOFF-2026-09-13.th.md). Document map: [docs/README.md](../../README.md). The stacked 13/12 September pointers below are historical; do not use them as the current entry.

---

# Current implementation entry point — 2026-09-12

Implementation has started on `caret/g0-omp-foundation`. Read
[the current direction](../2026-09-14-pre-ssot/CARET-IMPLEMENTATION-DIRECTION-2026-09-12.th.md)
and [AGENTS.md](../../../AGENTS.md) before the historical handoff below.
G0 fixture evidence does not imply release, visual parity, or full OMP conformance.
Continuation: [G1 UI/host side channels](../2026-09-14-pre-ssot/CARET-G1-IMPLEMENTATION-2026-09-12.th.md)
records the current implementation and remaining conformance gates.
