...
> Archived 10 September 2026 control-repo status. Living rules: [AGENTS.md](../../../AGENTS.md).

The files below are dated control-repo state. They do not restore Synara or
OpenCode as the product harness.
