...
[Machine-readable source inventory](../../maintenance/evidence/omp-rpc-2026-09-12/source-inventory.json) เก็บชื่อจริง: 28 built-in tools, 3 hidden tools, 42 RPC commands และชื่อ slash commands แยกตามหก registry modules. RPC command ID ไม่ใช่ slash command และ browser/computer ไม่จำเป็นต้องเป็น top-level model tool
