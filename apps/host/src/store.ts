/**
 * Durable metadata and command/event store for the Caret host.
 *
 * OMP remains the execution and transcript authority.  This store keeps only
 * Caret's durable projection: projects, session ownership metadata, command
...
export class DurableStoreOwnershipError extends DurableStoreError {
	constructor(message = "Another Caret host already owns this state directory", cause?: unknown) {
