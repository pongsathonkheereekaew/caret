 ...
 *
 * Cursor puts Explain and Fix on the selection next to the edit action. Cedia
...
export const SELECTION_ACTIONS: readonly SelectionActionSpec[] = [
	{
		id: "explain",
		command: "cedia.explainSelection",
		title: "Cedia: Explain Selection",
		instruction: "Explain what this selected code does, and call out anything surprising or risky.",
	},
	{
		id: "fix",
		command: "cedia.fixSelection",
		title: "Cedia: Fix Selection",
...
export function selectionAction(id: SelectionActionId): SelectionActionSpec {
	...
	if (!found) throw new Error(`unknown Cedia selection action: ${id}`);
	return found;
}
