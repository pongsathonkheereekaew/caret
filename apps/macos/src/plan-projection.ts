...
export const PLAN_RETRY_REASON = "OMP has not advertised plan step retry. Cedia will not invent a retry owner.";
export const PLAN_CANCEL_REASON = "OMP has not advertised subagent cancel. Cedia will not stop a child run from this strip.";
