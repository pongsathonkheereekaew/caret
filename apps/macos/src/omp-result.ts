...
export const THINKING_NOT_APPLIED_REASON =
	"Cedia could not change the thinking level: OMP did not confirm it. The previous level is still in effect.";
export const FORK_NOT_CREATED_REASON =
	"Cedia could not fork this task: OMP did not confirm the new session. The original task is unchanged.";
