...
const NO_INVENTED_BACKEND = "Caret does not invent the backend";
...
const GATED = [
	...
	{ key: "voice" as const, id: "voice", label: "Voice", owner: "caret" },
	{ key: "cloud" as const, id: "cloud", label: "Cloud", owner: "caret" },
	{ key: "automations" as const, id: "automations", label: "Automations", owner: "caret" },
];
