/** D18: New worktree receipts. Cancel before submit creates nothing. Cancel in flight reconciles; Caret does not delete a folder that may have user files. */
...
export const WORKTREE_CANCEL_IN_FLIGHT_COPY =
	"Cancel asked the host to stop. Caret will not delete a folder that may already have user files.";
