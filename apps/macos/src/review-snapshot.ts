...
export const REVIEW_STALE_REASON = "ไฟล์เปลี่ยนแล้ว — โหลด diff ใหม่. The file changed — reload the diff. Caret will not apply a stale hunk.";
export const REVIEW_NO_GIT_REASON = "This folder is not a Git repository. Git setup is an explicit choice. Caret does not initialize a repository from this panel.";
export const REVIEW_NO_PROPOSAL_REASON = "No advertised agent proposals for this folder. Caret does not invent hunks outside Git or OMP.";
export const REVIEW_DIRTY_REASON = "ไฟล์มีการแก้ไขใหม่ ยังไม่ได้นำข้อเสนอไปใช้. The file has unsaved edits. Caret will not apply a proposal over a dirty buffer.";
...
export const COMMIT_NO_CONTRACT_REASON =
	"Commit stays in Code-OSS until OMP advertises a task-scoped commit contract. Caret will not auto-push.";
...
export const REVIEW_CONFLICT_REASON =
	"Conflict. Caret will not merge. Open the Code-OSS merge editor if Git advertised one.";
export const REVIEW_BRING_BACK_REASON =
	"OMP has not advertised a checkpoint to restore. Caret will not invent a bring-back.";
