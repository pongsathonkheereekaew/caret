 ...
 *
 * Why this exists: the terminal Caret ships is xterm.js from the pinned Code-OSS
 * base, and nothing in this repository has ever asserted what that engine does with
 * the sequences Caret's own surfaces depend on (VS Code's shell integration, OSC 8
 ...
 *
 * Cases marked `required: true` are the ones Caret must keep; the rest are recorded
...
export const TERMINAL_CONFORMANCE_CASES: readonly TerminalConformanceCase[] = [
	...
	},
	{
		...
		input: "\x1b]0;caret title\x07\x1b]133;A\x07prompt\x1b]133;B\x07cmd\r\n",
		required: true,
	...
	},
	{
		...
		note: "Caret's users type Thai; a dropped combining mark is a visible defect",
	},
	{
		id: "cjk-width",
	...
	},
	{
		...
		required: false,
		expectRows: ["👩‍💻 family 👨‍👩‍👧"],
		note: "recorded, not asserted: engines disagree on ZWJ sequence width, and the screen text is what Caret renders",
	},
];
