...
export const CLONE_UNAVAILABLE_REASON = "Clone stays unavailable until a Cedia git-clone contract exists. Cedia will not run git clone from this screen.";
export const MISSING_RECENT_REASON = "This folder is missing. Cedia will not invent a replacement project.";

/**
 * What adding a folder to Cedia has to do, given what the host already holds.
 *
 ...
 * duplicated, and adding back a project Cedia had removed un-archives its record.
 */
