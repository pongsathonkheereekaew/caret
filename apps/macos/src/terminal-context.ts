...
export const TERMINAL_NOT_FOCUSED_REASON =
	"Focus a terminal first. Caret cites the selection from the active terminal, not a guessed one.";
export const TERMINAL_NO_SELECTION_REASON =
	"Select terminal output first. Caret cites the real selection; it will not send the whole scrollback.";
