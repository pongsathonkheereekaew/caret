...
/** WCAG-oriented contrast floors for Caret themes: text 4.5:1, UI 3:1. */
 ...
 * workbench bundle as `--cursor-duration-*` and `--cursor-easing-*`. Caret's
 * tokens are mapped onto that scale so the shell animates like the reference
 * rather than with a Caret-invented curve:
 *
