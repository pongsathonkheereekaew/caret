...
interface RightDockProps {
  ...
  /** The host shell owns the fixed-position toggle in this mode. */
...
export function RightDock(props: RightDockProps) {
  ...
  useEffect(() => {
    ...
    try {
      persistedWidth = getLocalStorageItem(RIGHT_DOCK_WIDTH_STORAGE_KEY, Schema.Finite);
    } catch {
        ...
        >
          <div
            className={cn(
              ...
              props.collapseInShell ? "pr-9" : null,
