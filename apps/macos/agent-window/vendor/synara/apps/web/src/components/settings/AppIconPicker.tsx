...
const APP_ICON_OPTIONS = {
  default: { label: "Default icon", src: publicAssetUrl("app-icons/default.png") },
  icon: { label: "Icon", src: publicAssetUrl("app-icons/icon-group-600-macos.png") },
  dark: { label: "Dark icon", src: publicAssetUrl("app-icons/dark.png") },
