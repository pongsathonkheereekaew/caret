...
export function BrowserPanel({
  ...
  const [addressSuggestionsSuppressed, setAddressSuggestionsSuppressed] = useState(true);
        ...
        >
          <Input
            ...
            onBlur={() => {
              isAddressEditingRef.current = false;
              setIsAddressFocused(false);
              // macOS restores the last focused DOM input before dispatching a click
              // from the native page back into the shell. Do not let that focus alone
              // reopen suggestions over the tab strip and swallow the intended click.
              setAddressSuggestionsSuppressed(true);
            }}
            onMouseDown={() => {
              setAddressSuggestionsSuppressed(false);
