...
// OMP owns model selection and exposes its catalogue at runtime. Keep the
// selected thinking level opaque so the UI can carry exactly the value OMP
// advertised without inventing an effort ladder here.
...
export const MODEL_OPTIONS_BY_PROVIDER = {
  ...
  // OMP owns this catalogue. The web client fills it from runtime discovery;
  // an empty static list is intentional and prevents fabricated model ids.
  omp: [],
