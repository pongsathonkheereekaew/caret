...
/** OMP is the sole runtime identity; its model catalog is supplied at runtime. */
...
// OMP is hosted by Cedia's native adapter; there is no user-selectable binary
// or upstream runtime path to persist here.
