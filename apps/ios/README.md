...
The phone controls sessions owned by the Mac host through an encrypted Paseo relay. Pair using the private QR code from **Cedia: Pair iPhone** on the Mac. Credentials live in Expo SecureStore; cached task state contains no pairing credential.
