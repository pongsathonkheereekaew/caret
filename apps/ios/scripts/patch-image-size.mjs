...
const patches = [
  { file: "icns.js", sha: "5e6a097fca237b0bb3b68a1be920e39a3846c0018d8917658b5ed88590a710e8", before: "    const imageLengthOffset = imageOffset + ENTRY_LENGTH_OFFSET;", after: `    // Cedia bounds backport: every ICNS entry must advance past its header.
  ...
  { file: "utils.js", sha: "e9faf86abcc962a5fc2488a4c3c9d8dc915aa22a0dd6a7bad6556cd9a326c349", before: `    if (input.length - offset < 4)
        return;
    const boxSize = (0, exports.readUInt32BE)(input, offset);`, after: `    // Cedia bounds backport: box size zero extends to EOF; every box advances.
