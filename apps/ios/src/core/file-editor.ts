...
export const IOS_FILE_BINARY_REASON =
  "Binary files are download-only on this phone. Cedia will not open them as text.";

export const IOS_FILE_DIRTY_CONFLICT_TH = "ไฟล์มีการแก้ไขใหม่ ยังไม่ได้นำข้อเสนอไปใช้";
export const IOS_FILE_DIRTY_CONFLICT_EN = "The file has newer edits. Cedia will not overwrite the Mac buffer.";

export const IOS_FILE_UNAVAILABLE_COPY =
  "No versioned file is advertised on this phone. Open the file on the Mac. Cedia will not invent a workspace listing.";
